...
object KtDefaultErrorMessagesSerialization : BaseDiagnosticRendererFactory() {
    ...
    override val MAP = KtDiagnosticFactoryToRendererMap("Serialization").apply {
        ...
        put(FirSerializationErrors.PLUGIN_IS_NOT_ENABLED,
        ...
        put(FirSerializationErrors.ANONYMOUS_OBJECTS_NOT_SUPPORTED,
                "Anonymous objects or contained in it classes can not be serializable.")
        put(FirSerializationErrors.INNER_CLASSES_NOT_SUPPORTED,
        ...
        put(FirSerializationErrors.COMPANION_OBJECT_AS_CUSTOM_SERIALIZER_DEPRECATED,
        ...
        put(FirSerializationErrors.COMPANION_OBJECT_SERIALIZER_INSIDE_OTHER_SERIALIZABLE_CLASS,
                ...
                FirDiagnosticRenderers.RENDER_TYPE, FirDiagnosticRenderers.RENDER_TYPE)
        put(FirSerializationErrors.COMPANION_OBJECT_SERIALIZER_INSIDE_NON_SERIALIZABLE_CLASS,
                ...
                FirDiagnosticRenderers.RENDER_TYPE, FirDiagnosticRenderers.RENDER_TYPE)
        put(FirSerializationErrors.EXPLICIT_SERIALIZABLE_IS_REQUIRED,
        ...
        put(FirSerializationErrors.SERIALIZABLE_ANNOTATION_IGNORED,
        ...
        put(FirSerializationErrors.NON_SERIALIZABLE_PARENT_MUST_HAVE_NOARG_CTOR,
        ...
        put(FirSerializationErrors.PRIMARY_CONSTRUCTOR_PARAMETER_IS_NOT_A_PROPERTY,
                "This class is not serializable automatically because it has primary constructor parameters that are not properties")
        put(FirSerializationErrors.DUPLICATE_SERIAL_NAME,
                "Serializable class has duplicate serial name of property ''{0}'', either in the class itself or its supertypes",
                CommonRenderers.STRING)
        put(FirSerializationErrors.DUPLICATE_SERIAL_NAME_ENUM,
                "Enum class ''{0}'' has duplicate serial name ''{1}'' in entry ''{2}''", FirDiagnosticRenderers.SYMBOL,
                CommonRenderers.STRING, CommonRenderers.STRING)
        put(FirSerializationErrors.SERIALIZER_NOT_FOUND,
        ...
        put(FirSerializationErrors.ABSTRACT_SERIALIZER_TYPE,
                ...
                FirDiagnosticRenderers.RENDER_TYPE, FirDiagnosticRenderers.RENDER_TYPE)
        put(FirSerializationErrors.LOCAL_SERIALIZER_USAGE,
                "Class ''{0}'' can't be used as a serializer since it is local", FirDiagnosticRenderers.RENDER_TYPE)
        put(FirSerializationErrors.TRANSIENT_MISSING_INITIALIZER,
                "This property is marked as @Transient and therefore must have an initializing expression")
        put(FirSerializationErrors.TRANSIENT_IS_REDUNDANT,
                "Property does not have backing field which makes it non-serializable and therefore @Transient is redundant")
        put(FirSerializationErrors.INCORRECT_TRANSIENT,
                "@kotlin.jvm.Transient does not affect @Serializable classes. Please use @kotlinx.serialization.Transient instead.")
        put(FirSerializationErrors.GENERIC_ARRAY_ELEMENT_NOT_SUPPORTED,
                "Serialization of Arrays with generic type arguments is impossible because of unknown compile-time type.")
        put(FirSerializationErrors.REQUIRED_KOTLIN_TOO_HIGH,
        ...
        put(FirSerializationErrors.PROVIDED_RUNTIME_TOO_LOW,
        ...
        put(FirSerializationErrors.INCONSISTENT_INHERITABLE_SERIALINFO,
                "Argument values for inheritable serial info annotation ''{0}'' must be the same as the values in parent type ''{1}''",
                FirDiagnosticRenderers.RENDER_TYPE, FirDiagnosticRenderers.RENDER_TYPE)
        put(FirSerializationErrors.META_SERIALIZABLE_NOT_APPLICABLE,
                "@MetaSerializable annotation can be used only on top-level annotation classes.")
        put(FirSerializationErrors.INHERITABLE_SERIALINFO_CANT_BE_REPEATABLE,
        ...
        put(FirSerializationErrors.EXTERNAL_CLASS_NOT_SERIALIZABLE,
                ...
                FirDiagnosticRenderers.SYMBOL, FirDiagnosticRenderers.RENDER_TYPE)

        put(FirSerializationErrors.EXTERNAL_CLASS_IN_ANOTHER_MODULE,
