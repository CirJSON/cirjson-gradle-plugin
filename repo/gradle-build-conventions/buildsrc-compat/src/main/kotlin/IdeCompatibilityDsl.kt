...
val CompatibilityPredicate.not: CompatibilityPredicate
    get() = object : CompatibilityPredicate {
...
enum class Platform : CompatibilityPredicate {
    ...
    companion object {
        operator fun get(version: Int): Platform {
            return Platform.values().firstOrNull { it.version == version } ?: error("Can't find platform $version")
        }
    }
}
