...
@JvmOverloads fun Project.configureJava9Compilation(moduleName: String,
    ...
    tasks.named("compileJava9Kotlin", KotlinCompile::class.java) {
        ...
        @Suppress("DEPRECATION") kotlinOptions.jvmTarget = JdkMajorVersion.JDK_9_0.targetName
    }
    ...
    tasks.named("compileJava9Java", JavaCompile::class.java) {
        ...
        options.compilerArgumentProviders.add(Java9AdditionalArgumentsProvider(moduleName, moduleFiles, modulePath))
    }
}

private class Java9AdditionalArgumentsProvider(private val moduleName: String, private val moduleFiles: FileCollection,
        private val modulePath: FileCollection) : CommandLineArgumentProvider {
    override fun asArguments(): Iterable<String> =
        listOf("--module-path", modulePath.asPath, "--patch-module", "$moduleName=${moduleFiles.asPath}",
...
@JvmOverloads fun Project.manifestAttributes(manifest: Manifest, component: String? = null,
        multiRelease: Boolean = false) {
    manifest.attributes("Implementation-Vendor" to "JetBrains",
    ...
    if (component != null) {
        ...
        manifest.attributes("Kotlin-Runtime-Component" to component, "Kotlin-Version" to kotlinLanguageVersion)
    }
